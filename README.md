...
- Analyze BMW sales performance between **2010 and 2024**
- Identify the **most popular BMW models**
- Study the influence of **colour and transmission** on customer preferences
- Observe **year-over-year (YoY) sales growth**
...
|----------------|-------------|
| Model          | BMW vehicle model (e.g., X5, 3-Series, M3) |
| Year           | Sales year (2010–2024) |
| Region         | Global regions (e.g., Europe, Asia, Africa) |
